...
while True:
    ...
    if window or window[0].isActive:
        ...
        if islem:
            ...
            results = model.predict(screenshot, conf=0.3)
            ...
            for index, row in px.iterrows():
                ...
                d = int(d)
                if d == 9:
                    if is_object_in_area(x1, y1, x2, y2, pol2):
                        yap = False
                if (d == 4 or d == 2):
                    ...
                    if is_object_in_area(x1, y1, x2, y2, ana):
                        if d == 7:
                            ...
                            pyautogui.mouseUp(button='left')
                            pyautogui.moveTo(x,y,duration=0)
                            print("Diken denk geldiği için çift zıpladı")
                        else:
                            pyautogui.mouseDown(button='left')
                            pyautogui.moveTo(x, y-30,duration=0.1)
                            pyautogui.mouseUp(button='left')
                            pyautogui.moveTo(x,y,duration=0)
                            print("zehir, L veya PUZLE denk geldiği için zıpladı")
                    ...
                    if is_object_in_area(x1, y1, x2, y2, pol1):
                        sol_dolu = True
                elif d == 3 or d == 5 or d == 6:
                    if neredeyim == 2:
                        if is_object_in_area(x1, y1, x2, y2, pol2):
                            for index, row in px.iterrows():
                                x3, y3, x4, y4, d4 = map(int, row[[0, 1, 2, 3, 5]])
                                d4 = int(d)
                                if d == 3 or d == 5 or d == 6 or d == 8:
                                    if is_object_in_area(x3, y3, x4, y4, pol1):
                                        sol_dolu = True
                                    else:
                                        sol_dolu = False
                            if d ==5 or d== 6:
                                if d == 5 and is_object_in_area(x1, y1, x2, y2, ana):
                                    print("Ortadayken duvar bulduğu için çift zıpladı")
                                    pyautogui.mouseDown(button='left')
                                    pyautogui.moveTo(x, y-30,duration=0.1)
                                    pyautogui.mouseUp(button='left')
                                    time.sleep(0.2)
                                ...
                                if d == 6:
                                    ...
                                    pyautogui.mouseUp(button='left')
                                    pyautogui.moveTo(x,y,duration=0)
                                    print("Soldayken top bulduğu için çift zıpladı")
                            else:
                                if not sol_dolu:
                                    #cv2.rectangle(screenshot, (x1, y1), (x2, y2), (0, 255, 0), 2)
                                    pyautogui.mouseDown(button='left')
                                    ...
                                    pyautogui.mouseUp(button='left')
                                    pyautogui.moveTo(x,y,duration=0)
                                    print("Ortadayken oyun kolu bulduğu için sola geçti")
                                    neredeyim = 1
                                else:
                                    #cv2.rectangle(screenshot, (x1, y1), (x2, y2), (0, 255, 0), 2)
                                    pyautogui.mouseDown(button='left')
                                    ...
                                    pyautogui.mouseUp(button='left')
                                    pyautogui.moveTo(x,y,duration=0)
                                    print("Ortadayken oyun kolu bulduğu için sağa geçti")
                                    neredeyim = 3
                        ...
                        if is_object_in_area(x1, y1, x2, y2, pol2):
                            for index, row in px.iterrows():
                                ...
                                d4 = int(d)
                                if d == 3 or d == 5 or d == 6 or d == 8:
                                    if is_object_in_area(x3, y3, x4, y4, pol3):
                                        sag_dolu = True
                                    else:
                                        sag_dolu = False
                            if d ==5 or d== 6:
                                ...
                                pyautogui.moveTo(x,y,duration=0)
                                if d == 5:
                                    print("Soldayken duvar bulduğu için çift zıpladı")
                                else:
                                    print("Soldayken top bulduğu için çift zıpladı")
                            else:
                                if not sag_dolu:
                                    #cv2.rectangle(screenshot, (x1, y1), (x2, y2), (0, 255, 0), 2)   
                                    pyautogui.mouseDown(button='left')
                                    pyautogui.moveTo(x+30, y,duration=0.2)
                                    pyautogui.mouseUp(button='left')
                                    pyautogui.moveTo(x,y,duration=0)
                                    print("Soldayken oyun kolu bulduğu için Ortadaya geçti")
                                    neredeyim = 2
                    elif neredeyim == 3:
                        if is_object_in_area(x1, y1, x2, y2, pol2):
                            for index, row in px.iterrows():
                            ...
                            if d ==5 or d== 6:
                                ...
                                pyautogui.moveTo(x,y,duration=0)
                                if d == 5:
                                    print("Sağdayken duvar bulduğu için çift zıpladı")
                                else:
                                    print("Sağdayken top bulduğu için çift zıpladı")
                            else:
                                if not sol_dolu:
                                    #cv2.rectangle(screenshot, (x1, y1), (x2, y2), (0, 255, 0), 2)   
                                    pyautogui.mouseDown(button='left')
                                    ...
                                    pyautogui.mouseUp(button='left')
                                    pyautogui.moveTo(x,y,duration=0)
                                    print("Sağdayken oyun kolu bulduğu için Ortadaya geçti")
                                    neredeyim = 2
                #cv2.rectangle(screenshot, (x1, y1), (x2, y2), (0, 255, 0), 2)
                    #result.save(filename=f'deneme/result{a}.jpg')  # save to disk
            if yap and not sag_dolu and not sol_dolu and  time.time() - a7 > 2:
                for index, row in px.iterrows():
                    x1, y1, x2, y2, d = map(int, row[[0, 1, 2, 3, 5]])
                    d = int(d)
                
                    if d == 9 or d == 10:
                        if neredeyim == 2 and time.time() - a7 > 1:
                            if is_object_in_area(x1, y1, x2, y2, pol6):
                            ...
                            elif is_object_in_area(x1, y1, x2, y2, pol4) and time.time() - a7 > 1:
                                #cv2.rectangle(screenshot, (x1, y1), (x2, y2), (0, 255, 0), 2)
                                pyautogui.mouseDown(button='left')
                                pyautogui.moveTo(x-30, y,duration=0.1)
                                pyautogui.mouseUp(button='left')
                                ...
                                a7 = time.time()
                        elif neredeyim == 1 and time.time() - a7 > 1:
                            if is_object_in_area(x1,y1,x2,y2,pol6):
                                #cv2.rectangle(screenshot, (x1, y1), (x2, y2), (0, 255, 0), 2)
                                pyautogui.mouseDown(button='left')
                                pyautogui.moveTo(x+30, y,duration=0.1)
                                ...
                                a7 = time.time()
                        elif neredeyim == 3 and time.time() - a7 > 1:
            ...
            if sorgu2-sorgu > 2:
                ...
                try:
                    search_image = xpng
                    result = pyautogui.locate(search_image[60:,:], af, confidence=0.7)
